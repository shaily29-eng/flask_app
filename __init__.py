...
app.config['SQLALCHEMY_DATABASE_URI']='sqlite:///data.db' #hold user information
...
def products():
    ...
    products=[
        {'ID':1,'name':'snow shovel','sku':'shl3'},
        {'ID':2,'name':'barbeque show','sku':'bbq1'},
        {'ID':3,'name':'screw driver','sku':'sdr1'},
    ]
...
def departments():
    ...
    departments=[
        {'ID':1,'name':'human resources','number':100},
        {'ID':2,'name':'information technology','number':101},
        {'ID':3,'name':'customer services','number':102},
    ]
